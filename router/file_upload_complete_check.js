...
//
//
// global.router.file.file_upload_complete_check = function( req, res, d ){
// 	var _q = JSON.parse( d )
// 	global.api.file.file_upload_complete_check( req, res, _q, global.util.response.res_200_ok_String )
// }
//
//
// global.api.file.file_upload_complete_check = function( req, res, d, _cbFunction ){
// 	var _q = JSON.parse( d )
...
// 		}
//
// 		global.CSJLog.timeStamp( stats.size," / ",_q.totalBytes )
// 		var r = {
// 			fileNm : _q.fileNm
